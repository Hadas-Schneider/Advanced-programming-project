...
class TestInventory(unittest.TestCase):
    ...
    def test_get_furniture_type_found(self):
        """Test when the item is found in the inventory."""
        self.inventory.add_item(self.chair)
        self.inventory.add_item(self.table)
        result = self.inventory.get_furniture_type("Office Chair")
        self.assertEqual(result, "Chair")

        result = self.inventory.get_furniture_type("Dining Table")
        self.assertEqual(result, "Table")

    def test_get_furniture_type_not_found(self):
        """Test when the item is not found in the inventory."""
        self.inventory.add_item(self.chair)
        result = self.inventory.get_furniture_type("Nonexistent Item")
        self.assertIsNone(result)

    def test_get_furniture_type_empty_inventory(self):
